...
class AppColors {
  ...
  static const textfieldInnerGrey = Color(0xaaE4E6E9);
  static const bodyIconsGrey = Color(0xff616871);
  static const commentsContainerGrey = Color(0xffF0F2F5);
  static const activeUserGreen = Color(0xff2F9A48);
}
